...
/**
 * The workshop's type, loaded once for both of its routes.
 *
 ...
 * scoped to the poster's two pages the same way its colours are — three families
 * fetched here are three families the front page never pays for.
 *
 ...
 * 4rem, illegible as a paragraph, so `theme.js` never lets it below ~1rem.
 *
